...
namespace EnumsNET
{
	...
	public static class Enums
	{
		...
		[Pure]
		public static bool IsContiguous<[EnumConstraint] TEnum>() => EnumsCache<TEnum>.IsContiguous;
		...
		[Pure]
		public static Type GetUnderlyingType<[EnumConstraint] TEnum>() => EnumsCache<TEnum>.UnderlyingType;
		#endregion
		...
		[Pure]
		public static int GetDefinedCount<[EnumConstraint] TEnum>(bool uniqueValued = false) => EnumsCache<TEnum>.GetDefinedCount(uniqueValued);

		[Pure]
		public static EnumMemberInfo<TEnum>[] GetEnumMemberInfos<[EnumConstraint] TEnum>(bool uniqueValued = false) => EnumsCache<TEnum>.GetEnumMemberInfos(uniqueValued);
		...
		[Pure]
		public static string[] GetNames<[EnumConstraint] TEnum>(bool uniqueValued = false) => EnumsCache<TEnum>.GetNames(uniqueValued);
		...
		[Pure]
		public static TEnum[] GetValues<[EnumConstraint] TEnum>(bool uniqueValued = false) => EnumsCache<TEnum>.GetValues(uniqueValued);
		...
		[Pure]
		public static string[] GetDescriptions<[EnumConstraint] TEnum>(bool uniqueValued = false) => EnumsCache<TEnum>.GetDescriptions(uniqueValued);

		[Pure]
		public static string[] GetDescriptionsOrNames<[EnumConstraint] TEnum>(bool uniqueValued = false) => EnumsCache<TEnum>.GetDescriptionsOrNames(uniqueValued);

		public static string[] GetDescriptionsOrNames<[EnumConstraint] TEnum>(Func<string, string> nameFormatter, bool uniqueValued = false) => EnumsCache<TEnum>.GetDescriptionsOrNames(nameFormatter, uniqueValued);
		...
		[Pure]
		public static string[] GetEnumMemberValues<[EnumConstraint] TEnum>(bool uniqueValued = false) => EnumsCache<TEnum>.GetEnumMemberValues(uniqueValued);
		...
		[Pure]
		public static Attribute[][] GetAllAttributes<[EnumConstraint] TEnum>(bool uniqueValued = false) => EnumsCache<TEnum>.GetAllAttributes(uniqueValued);
		...
		public static TAttribute[] GetAttributes<[EnumConstraint] TEnum, TAttribute>(bool uniqueValued = false)
			where TAttribute : Attribute => EnumsCache<TEnum>.GetAttributes<TAttribute>(uniqueValued);
		...
		[Pure]
		public static int Compare<[EnumConstraint] TEnum>(TEnum x, TEnum y) => EnumsCache<TEnum>.Compare(x, y);
		#endregion
		...
		[Pure]
		public static bool IsValid<[EnumConstraint] TEnum>(object value) => EnumsCache<TEnum>.IsValid(value);
		...
		/// whether it's a valid flag combination of <typeparamref name="TEnum"/>'s defined values.</returns>
		[Pure]
		public static bool IsValid<[EnumConstraint] TEnum>(this TEnum value) => EnumsCache<TEnum>.IsValid(value);
		...
		/// whether it's a valid flag combination of <typeparamref name="TEnum"/>'s defined values.</returns>
		[Pure]
		public static bool IsValid<[EnumConstraint] TEnum>(sbyte value) => EnumsCache<TEnum>.IsValid(value);
		...
		/// whether it's a valid flag combination of <typeparamref name="TEnum"/>'s defined values.</returns>
		[Pure]
		public static bool IsValid<[EnumConstraint] TEnum>(byte value) => EnumsCache<TEnum>.IsValid(value);
		...
		/// whether it's a valid flag combination of <typeparamref name="TEnum"/>'s defined values.</returns>
		[Pure]
		public static bool IsValid<[EnumConstraint] TEnum>(short value) => EnumsCache<TEnum>.IsValid(value);
		...
		/// whether it's a valid flag combination of <typeparamref name="TEnum"/>'s defined values.</returns>
		[Pure]
		public static bool IsValid<[EnumConstraint] TEnum>(ushort value) => EnumsCache<TEnum>.IsValid(value);
		...
		/// whether it's a valid flag combination of <typeparamref name="TEnum"/>'s defined values.</returns>
		[Pure]
		public static bool IsValid<[EnumConstraint] TEnum>(int value) => EnumsCache<TEnum>.IsValid(value);
		...
		/// whether it's a valid flag combination of <typeparamref name="TEnum"/>'s defined values.</returns>
		[Pure]
		public static bool IsValid<[EnumConstraint] TEnum>(uint value) => EnumsCache<TEnum>.IsValid(value);
		...
		/// whether it's a valid flag combination of <typeparamref name="TEnum"/>'s defined values.</returns>
		[Pure]
		public static bool IsValid<[EnumConstraint] TEnum>(long value) => EnumsCache<TEnum>.IsValid(value);
		...
		/// whether it's a valid flag combination of <typeparamref name="TEnum"/>'s defined values.</returns>
		[Pure]
		public static bool IsValid<[EnumConstraint] TEnum>(ulong value) => EnumsCache<TEnum>.IsValid(value);
		#endregion
		...
		[Pure]
		public static bool IsDefined<[EnumConstraint] TEnum>(object value) => EnumsCache<TEnum>.IsDefined(value);
		...
		[Pure]
		public static bool IsDefined<[EnumConstraint] TEnum>(this TEnum value) => EnumsCache<TEnum>.IsDefined(value);
		...
		[Pure]
		public static bool IsDefined<[EnumConstraint] TEnum>(string name) => EnumsCache<TEnum>.IsDefined(name);
		...
		/// <exception cref="ArgumentNullException"><paramref name="name"/> is null</exception>
		[Pure]
		public static bool IsDefined<[EnumConstraint] TEnum>(string name, bool ignoreCase) => EnumsCache<TEnum>.IsDefined(name, ignoreCase);
		...
		[Pure]
		public static bool IsDefined<[EnumConstraint] TEnum>(sbyte value) => EnumsCache<TEnum>.IsDefined(value);
		...
		/// and that that value is defined.</returns>
		[Pure]
		public static bool IsDefined<[EnumConstraint] TEnum>(byte value) => EnumsCache<TEnum>.IsDefined(value);
		...
		/// and that that value is defined.</returns>
		[Pure]
		public static bool IsDefined<[EnumConstraint] TEnum>(short value) => EnumsCache<TEnum>.IsDefined(value);
		...
		/// and that that value is defined.</returns>
		[Pure]
		public static bool IsDefined<[EnumConstraint] TEnum>(ushort value) => EnumsCache<TEnum>.IsDefined(value);
		...
		/// and that that value is defined.</returns>
		[Pure]
		public static bool IsDefined<[EnumConstraint] TEnum>(int value) => EnumsCache<TEnum>.IsDefined(value);
		...
		/// and that that value is defined.</returns>
		[Pure]
		public static bool IsDefined<[EnumConstraint] TEnum>(uint value) => EnumsCache<TEnum>.IsDefined(value);
		...
		/// and that that value is defined.</returns>
		[Pure]
		public static bool IsDefined<[EnumConstraint] TEnum>(long value) => EnumsCache<TEnum>.IsDefined(value);
		...
		/// and that that value is defined.</returns>
		[Pure]
		public static bool IsDefined<[EnumConstraint] TEnum>(ulong value) => EnumsCache<TEnum>.IsDefined(value);
		#endregion
		...
		[Pure]
		public static bool IsWithinUnderlyingTypesValueRange<[EnumConstraint] TEnum>(sbyte value) => EnumsCache<TEnum>.IsWithinUnderlyingTypesValueRange(value);
		...
		/// <returns>Indication whether the specified <paramref name="value"/> is within <typeparamref name="TEnum"/>'s underlying type's value range.</returns>
		[Pure]
		public static bool IsWithinUnderlyingTypesValueRange<[EnumConstraint] TEnum>(byte value) => EnumsCache<TEnum>.IsWithinUnderlyingTypesValueRange(value);
		...
		/// <returns>Indication whether the specified <paramref name="value"/> is within <typeparamref name="TEnum"/>'s underlying type's value range.</returns>
		[Pure]
		public static bool IsWithinUnderlyingTypesValueRange<[EnumConstraint] TEnum>(short value) => EnumsCache<TEnum>.IsWithinUnderlyingTypesValueRange(value);
		...
		/// <returns>Indication whether the specified <paramref name="value"/> is within <typeparamref name="TEnum"/>'s underlying type's value range.</returns>
		[Pure]
		public static bool IsWithinUnderlyingTypesValueRange<[EnumConstraint] TEnum>(ushort value) => EnumsCache<TEnum>.IsWithinUnderlyingTypesValueRange(value);
		...
		/// <returns>Indication whether the specified <paramref name="value"/> is within <typeparamref name="TEnum"/>'s underlying type's value range.</returns>
		[Pure]
		public static bool IsWithinUnderlyingTypesValueRange<[EnumConstraint] TEnum>(int value) => EnumsCache<TEnum>.IsWithinUnderlyingTypesValueRange(value);
		...
		/// <returns>Indication whether the specified <paramref name="value"/> is within <typeparamref name="TEnum"/>'s underlying type's value range.</returns>
		[Pure]
		public static bool IsWithinUnderlyingTypesValueRange<[EnumConstraint] TEnum>(uint value) => EnumsCache<TEnum>.IsWithinUnderlyingTypesValueRange(value);
		...
		/// <returns>Indication whether the specified <paramref name="value"/> is within <typeparamref name="TEnum"/>'s underlying type's value range.</returns>
		[Pure]
		public static bool IsWithinUnderlyingTypesValueRange<[EnumConstraint] TEnum>(long value) => EnumsCache<TEnum>.IsWithinUnderlyingTypesValueRange(value);
		...
		/// <returns>Indication whether the specified <paramref name="value"/> is within <typeparamref name="TEnum"/>'s underlying type's value range.</returns>
		[Pure]
		public static bool IsWithinUnderlyingTypesValueRange<[EnumConstraint] TEnum>(ulong value) => EnumsCache<TEnum>.IsWithinUnderlyingTypesValueRange(value);
		#endregion
		...
		[Pure]
		public static TEnum ToEnum<[EnumConstraint] TEnum>(object value, bool validate = true) => EnumsCache<TEnum>.ToEnum(value, validate);
		...
		/// <exception cref="OverflowException"><paramref name="value"/> is outside the underlying type's value range.</exception>
		[Pure]
		public static TEnum ToEnum<[EnumConstraint] TEnum>(sbyte value, bool validate = true) => EnumsCache<TEnum>.ToEnum(value, validate);
		...
		/// <exception cref="OverflowException"><paramref name="value"/> is outside the underlying type's value range.</exception>
		[Pure]
		public static TEnum ToEnum<[EnumConstraint] TEnum>(byte value, bool validate = true) => EnumsCache<TEnum>.ToEnum(value, validate);
		...
		/// <exception cref="OverflowException"><paramref name="value"/> is outside the underlying type's value range.</exception>
		[Pure]
		public static TEnum ToEnum<[EnumConstraint] TEnum>(short value, bool validate = true) => EnumsCache<TEnum>.ToEnum(value, validate);
		...
		/// <exception cref="OverflowException"><paramref name="value"/> is outside the underlying type's value range.</exception>
		[Pure]
		public static TEnum ToEnum<[EnumConstraint] TEnum>(ushort value, bool validate = true) => EnumsCache<TEnum>.ToEnum(value, validate);
		...
		/// <exception cref="OverflowException"><paramref name="value"/> is outside the underlying type's value range.</exception>
		[Pure]
		public static TEnum ToEnum<[EnumConstraint] TEnum>(int value, bool validate = true) => EnumsCache<TEnum>.ToEnum(value, validate);
		...
		/// <exception cref="OverflowException"><paramref name="value"/> is outside the underlying type's value range.</exception>
		[Pure]
		public static TEnum ToEnum<[EnumConstraint] TEnum>(uint value, bool validate = true) => EnumsCache<TEnum>.ToEnum(value, validate);
		...
		/// <exception cref="OverflowException"><paramref name="value"/> is outside the underlying type's value range.</exception>
		[Pure]
		public static TEnum ToEnum<[EnumConstraint] TEnum>(long value, bool validate = true) => EnumsCache<TEnum>.ToEnum(value, validate);
		...
		/// <exception cref="OverflowException"><paramref name="value"/> is outside the underlying type's value range.</exception>
		[Pure]
		public static TEnum ToEnum<[EnumConstraint] TEnum>(ulong value, bool validate = true) => EnumsCache<TEnum>.ToEnum(value, validate);
		...
		[Pure]
		public static TEnum ToEnumOrDefault<[EnumConstraint] TEnum>(object value, TEnum defaultEnum, bool validate = true) => EnumsCache<TEnum>.ToEnumOrDefault(value, defaultEnum, validate);
		...
		/// <returns>If succeeded <paramref name="value"/> converted to a <typeparamref name="TEnum"/> otherwise <paramref name="defaultEnum"/>.</returns>
		[Pure]
		public static TEnum ToEnumOrDefault<[EnumConstraint] TEnum>(sbyte value, TEnum defaultEnum, bool validate = true) => EnumsCache<TEnum>.ToEnumOrDefault(value, defaultEnum, validate);
		...
		/// <returns>If succeeded <paramref name="value"/> converted to a <typeparamref name="TEnum"/> otherwise <paramref name="defaultEnum"/>.</returns>
		[Pure]
		public static TEnum ToEnumOrDefault<[EnumConstraint] TEnum>(byte value, TEnum defaultEnum, bool validate = true) => EnumsCache<TEnum>.ToEnumOrDefault(value, defaultEnum, validate);
		...
		/// <returns>If succeeded <paramref name="value"/> converted to a <typeparamref name="TEnum"/> otherwise <paramref name="defaultEnum"/>.</returns>
		[Pure]
		public static TEnum ToEnumOrDefault<[EnumConstraint] TEnum>(short value, TEnum defaultEnum, bool validate = true) => EnumsCache<TEnum>.ToEnumOrDefault(value, defaultEnum, validate);
		...
		/// <returns>If succeeded <paramref name="value"/> converted to a <typeparamref name="TEnum"/> otherwise <paramref name="defaultEnum"/>.</returns>
		[Pure]
		public static TEnum ToEnumOrDefault<[EnumConstraint] TEnum>(ushort value, TEnum defaultEnum, bool validate = true) => EnumsCache<TEnum>.ToEnumOrDefault(value, defaultEnum, validate);
		...
		/// <returns>If succeeded <paramref name="value"/> converted to a <typeparamref name="TEnum"/> otherwise <paramref name="defaultEnum"/>.</returns>
		[Pure]
		public static TEnum ToEnumOrDefault<[EnumConstraint] TEnum>(int value, TEnum defaultEnum, bool validate = true) => EnumsCache<TEnum>.ToEnumOrDefault(value, defaultEnum, validate);
		...
		/// <returns>If succeeded <paramref name="value"/> converted to a <typeparamref name="TEnum"/> otherwise <paramref name="defaultEnum"/>.</returns>
		[Pure]
		public static TEnum ToEnumOrDefault<[EnumConstraint] TEnum>(uint value, TEnum defaultEnum, bool validate = true) => EnumsCache<TEnum>.ToEnumOrDefault(value, defaultEnum, validate);
		...
		/// <returns>If succeeded <paramref name="value"/> converted to a <typeparamref name="TEnum"/> otherwise <paramref name="defaultEnum"/>.</returns>
		[Pure]
		public static TEnum ToEnumOrDefault<[EnumConstraint] TEnum>(long value, TEnum defaultEnum, bool validate = true) => EnumsCache<TEnum>.ToEnumOrDefault(value, defaultEnum, validate);
		...
		/// <returns>If succeeded <paramref name="value"/> converted to a <typeparamref name="TEnum"/> otherwise <paramref name="defaultEnum"/>.</returns>
		[Pure]
		public static TEnum ToEnumOrDefault<[EnumConstraint] TEnum>(ulong value, TEnum defaultEnum, bool validate = true) => EnumsCache<TEnum>.ToEnumOrDefault(value, defaultEnum, validate);
		...
		/// <returns></returns>
		[Pure]
		public static bool TryToEnum<[EnumConstraint] TEnum>(object value, out TEnum result, bool validate = true) => EnumsCache<TEnum>.TryToEnum(value, out result, validate);
		...
		/// <returns></returns>
		[Pure]
		public static bool TryToEnum<[EnumConstraint] TEnum>(sbyte value, out TEnum result, bool validate = true) => EnumsCache<TEnum>.TryToEnum(value, out result, validate);
		...
		/// <returns></returns>
		[Pure]
		public static bool TryToEnum<[EnumConstraint] TEnum>(byte value, out TEnum result, bool validate = true) => EnumsCache<TEnum>.TryToEnum(value, out result, validate);
		...
		/// <returns></returns>
		[Pure]
		public static bool TryToEnum<[EnumConstraint] TEnum>(short value, out TEnum result, bool validate = true) => EnumsCache<TEnum>.TryToEnum(value, out result, validate);
		...
		/// <returns></returns>
		[Pure]
		public static bool TryToEnum<[EnumConstraint] TEnum>(ushort value, out TEnum result, bool validate = true) => EnumsCache<TEnum>.TryToEnum(value, out result, validate);
		...
		/// <returns></returns>
		[Pure]
		public static bool TryToEnum<[EnumConstraint] TEnum>(int value, out TEnum result, bool validate = true) => EnumsCache<TEnum>.TryToEnum(value, out result, validate);
		...
		/// <returns></returns>
		[Pure]
		public static bool TryToEnum<[EnumConstraint] TEnum>(uint value, out TEnum result, bool validate = true) => EnumsCache<TEnum>.TryToEnum(value, out result, validate);
		...
		/// <returns></returns>
		[Pure]
		public static bool TryToEnum<[EnumConstraint] TEnum>(long value, out TEnum result, bool validate = true) => EnumsCache<TEnum>.TryToEnum(value, out result, validate);
		...
		/// <returns></returns>
		[Pure]
		public static bool TryToEnum<[EnumConstraint] TEnum>(ulong value, out TEnum result, bool validate = true) => EnumsCache<TEnum>.TryToEnum(value, out result, validate);
		#endregion
		...
		[Pure]
		public static TEnum Validate<[EnumConstraint] TEnum>(this TEnum value, string paramName) => EnumsCache<TEnum>.Validate(value, paramName);
		...
		/// <returns></returns>
		[Pure]
		public static string AsString<[EnumConstraint] TEnum>(this TEnum value) => EnumsCache<TEnum>.AsString(value);
		...
		[Pure]
		public static string AsString<[EnumConstraint] TEnum>(this TEnum value, string format) => EnumsCache<TEnum>.AsString(value, format);

		[Pure]
		public static string AsString<[EnumConstraint] TEnum>(this TEnum value, params EnumFormat[] formats) => EnumsCache<TEnum>.AsString(value, formats);

		[Pure]
		public static string AsString<[EnumConstraint] TEnum>(string name) => EnumsCache<TEnum>.AsString(name);

		[Pure]
		public static string AsString<[EnumConstraint] TEnum>(string name, string format) => EnumsCache<TEnum>.AsString(name, format);

		[Pure]
		public static string AsString<[EnumConstraint] TEnum>(string name, params EnumFormat[] formats) => EnumsCache<TEnum>.AsString(name, formats);
		...
		/// <exception cref="FormatException"><paramref name="format"/> is an invalid value.</exception>
		[Pure]
		public static string Format<[EnumConstraint] TEnum>(this TEnum value, string format) => EnumsCache<TEnum>.Format(value, format);

		[Pure]
		public static string Format<[EnumConstraint] TEnum>(this TEnum value, params EnumFormat[] formats) => EnumsCache<TEnum>.Format(value, formats);

		[Pure]
		public static string Format<[EnumConstraint] TEnum>(string name, string format) => EnumsCache<TEnum>.Format(name, format);

		[Pure]
		public static string Format<[EnumConstraint] TEnum>(string name, params EnumFormat[] formats) => EnumsCache<TEnum>.Format(name, formats);
		...
		/// <returns></returns>
		[Pure]
		public static object GetUnderlyingValue<[EnumConstraint] TEnum>(this TEnum value) => EnumsCache<TEnum>.GetUnderlyingValue(value);
		...
		[Pure]
		public static sbyte ToSByte<[EnumConstraint] TEnum>(this TEnum value) => EnumsCache<TEnum>.ToSByte(value);
		...
		[Pure]
		public static byte ToByte<[EnumConstraint] TEnum>(this TEnum value) => EnumsCache<TEnum>.ToByte(value);
		...
		[Pure]
		public static short ToInt16<[EnumConstraint] TEnum>(this TEnum value) => EnumsCache<TEnum>.ToInt16(value);
		...
		[Pure]
		public static ushort ToUInt16<[EnumConstraint] TEnum>(this TEnum value) => EnumsCache<TEnum>.ToUInt16(value);
		...
		[Pure]
		public static int ToInt32<[EnumConstraint] TEnum>(this TEnum value) => EnumsCache<TEnum>.ToInt32(value);
		...
		[Pure]
		public static uint ToUInt32<[EnumConstraint] TEnum>(this TEnum value) => EnumsCache<TEnum>.ToUInt32(value);
		...
		[Pure]
		public static long ToInt64<[EnumConstraint] TEnum>(this TEnum value) => EnumsCache<TEnum>.ToInt64(value);
		...
		[Pure]
		public static ulong ToUInt64<[EnumConstraint] TEnum>(this TEnum value) => EnumsCache<TEnum>.ToUInt64(value);
		#endregion

		#region Defined Values Main Methods
		[Pure]
		public static EnumMemberInfo<TEnum> GetEnumMemberInfo<[EnumConstraint] TEnum>(this TEnum value) => EnumsCache<TEnum>.GetEnumMemberInfo(value);

		[Pure]
		public static EnumMemberInfo<TEnum> GetEnumMemberInfo<[EnumConstraint] TEnum>(string name) => EnumsCache<TEnum>.GetEnumMemberInfo(name);
		...
		[Pure]
		public static string GetName<[EnumConstraint] TEnum>(this TEnum value) => EnumsCache<TEnum>.GetName(value);
		...
		[Pure]
		public static string GetDescription<[EnumConstraint] TEnum>(this TEnum value) => EnumsCache<TEnum>.GetDescription(value);
		...
		/// <exception cref="ArgumentNullException"><paramref name="name"/> is null</exception>
		[Pure]
		public static string GetDescription<[EnumConstraint] TEnum>(string name) => EnumsCache<TEnum>.GetDescription(name);

		[Pure]
		public static string GetDescriptionOrName<[EnumConstraint] TEnum>(this TEnum value) => EnumsCache<TEnum>.GetDescriptionOrName(value);

		public static string GetDescriptionOrName<[EnumConstraint] TEnum>(this TEnum value, Func<string, string> nameFormatter) => EnumsCache<TEnum>.GetDescriptionOrName(value, nameFormatter);

		[Pure]
		public static string GetDescriptionOrName<[EnumConstraint] TEnum>(string name) => EnumsCache<TEnum>.GetDescriptionOrName(name);

		public static string GetDescriptionOrName<[EnumConstraint] TEnum>(string name, Func<string, string> nameFormatter) => EnumsCache<TEnum>.GetDescriptionOrName(name, nameFormatter);

		[Pure]
		public static string GetEnumMemberValue<[EnumConstraint] TEnum>(this TEnum value) => EnumsCache<TEnum>.GetEnumMemberValue(value);

		[Pure]
		public static string GetEnumMemberValue<[EnumConstraint] TEnum>(string name) => EnumsCache<TEnum>.GetEnumMemberValue(name);
		#endregion
		...
		public static bool HasAttribute<[EnumConstraint] TEnum, TAttribute>(this TEnum value)
			where TAttribute : Attribute => EnumsCache<TEnum>.HasAttribute<TAttribute>(value);
		...
		public static bool HasAttribute<[EnumConstraint] TEnum, TAttribute>(string name)
			where TAttribute : Attribute => EnumsCache<TEnum>.HasAttribute<TAttribute>(name);
		...
		public static TAttribute GetAttribute<[EnumConstraint] TEnum, TAttribute>(this TEnum value)
			where TAttribute : Attribute => EnumsCache<TEnum>.GetAttribute<TAttribute>(value);
		...
		public static TAttribute GetAttribute<[EnumConstraint] TEnum, TAttribute>(string name)
			where TAttribute : Attribute => EnumsCache<TEnum>.GetAttribute<TAttribute>(name);
		...
		public static TResult GetAttributeSelect<[EnumConstraint] TEnum, TAttribute, TResult>(this TEnum value, Func<TAttribute, TResult> selector, TResult defaultValue = default(TResult))
			where TAttribute : Attribute => EnumsCache<TEnum>.GetAttributeSelect(value, selector, defaultValue);
		...
		public static TResult GetAttributeSelect<[EnumConstraint] TEnum, TAttribute, TResult>(string name, Func<TAttribute, TResult> selector, TResult defaultValue = default(TResult))
			where TAttribute : Attribute => EnumsCache<TEnum>.GetAttributeSelect(name, selector, defaultValue);
		...
		public static TAttribute[] GetAttributes<[EnumConstraint] TEnum, TAttribute>(this TEnum value)
			where TAttribute : Attribute => EnumsCache<TEnum>.GetAttributes<TAttribute>(value);
		...
		public static TAttribute[] GetAttributes<[EnumConstraint] TEnum, TAttribute>(string name)
			where TAttribute : Attribute => EnumsCache<TEnum>.GetAttributes<TAttribute>(name);
		...
		[Pure]
		public static Attribute[] GetAllAttributes<[EnumConstraint] TEnum>(this TEnum value) => EnumsCache<TEnum>.GetAllAttributes(value);
		...
		/// <exception cref="ArgumentNullException">name is null</exception>
		[Pure]
		public static Attribute[] GetAllAttributes<[EnumConstraint] TEnum>(string name) => EnumsCache<TEnum>.GetAllAttributes(name);
		#endregion
		...
		[Pure]
		public static TEnum Parse<[EnumConstraint] TEnum>(string value) => EnumsCache<TEnum>.Parse(value);
		...
		/// <exception cref="OverflowException"><paramref name="value"/> is outside the range of the underlying type of <typeparamref name="TEnum"/></exception>
		[Pure]
		public static TEnum Parse<[EnumConstraint] TEnum>(string value, bool ignoreCase) => EnumsCache<TEnum>.Parse(value, ignoreCase);
		...
		/// <exception cref="OverflowException"><paramref name="value"/> is outside the range of the underlying type of <typeparamref name="TEnum"/></exception>
		[Pure]
		public static TEnum Parse<[EnumConstraint] TEnum>(string value, params EnumFormat[] parseFormatOrder) => EnumsCache<TEnum>.Parse(value, parseFormatOrder);
		...
		/// <exception cref="OverflowException"><paramref name="value"/> is outside the range of the underlying type of <typeparamref name="TEnum"/></exception>
		[Pure]
		public static TEnum Parse<[EnumConstraint] TEnum>(string value, bool ignoreCase, params EnumFormat[] parseFormatOrder) => EnumsCache<TEnum>.Parse(value, ignoreCase, parseFormatOrder);
		...
		/// <returns></returns>
		[Pure]
		public static TEnum ParseOrDefault<[EnumConstraint] TEnum>(string value, TEnum defaultEnum) => EnumsCache<TEnum>.ParseOrDefault(value, defaultEnum);
		...
		/// <returns></returns>
		[Pure]
		public static TEnum ParseOrDefault<[EnumConstraint] TEnum>(string value, bool ignoreCase, TEnum defaultEnum) => EnumsCache<TEnum>.ParseOrDefault(value, ignoreCase, defaultEnum);
		...
		/// <returns></returns>
		[Pure]
		public static TEnum ParseOrDefault<[EnumConstraint] TEnum>(string value, TEnum defaultEnum, params EnumFormat[] parseFormatOrder) => EnumsCache<TEnum>.ParseOrDefault(value, defaultEnum, parseFormatOrder);
		...
		/// <returns></returns>
		[Pure]
		public static TEnum ParseOrDefault<[EnumConstraint] TEnum>(string value, bool ignoreCase, TEnum defaultEnum, params EnumFormat[] parseFormatOrder) => EnumsCache<TEnum>.ParseOrDefault(value, ignoreCase, defaultEnum, parseFormatOrder);
		...
		/// <returns></returns>
		[Pure]
		public static bool TryParse<[EnumConstraint] TEnum>(string value, out TEnum result) => EnumsCache<TEnum>.TryParse(value, out result);
		...
		/// <returns></returns>
		[Pure]
		public static bool TryParse<[EnumConstraint] TEnum>(string value, bool ignoreCase, out TEnum result) => EnumsCache<TEnum>.TryParse(value, ignoreCase, out result);
		...
		/// <returns></returns>
		[Pure]
		public static bool TryParse<[EnumConstraint] TEnum>(string value, out TEnum result, params EnumFormat[] parseFormatOrder) => EnumsCache<TEnum>.TryParse(value, out result, parseFormatOrder);
		...
		/// <returns></returns>
		[Pure]
		public static bool TryParse<[EnumConstraint] TEnum>(string value, bool ignoreCase, out TEnum result, params EnumFormat[] parseFormatOrder) => EnumsCache<TEnum>.TryParse(value, ignoreCase, out result, parseFormatOrder);
		#endregion
